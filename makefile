...
hw7: main.o
ifeq (${OS}, Windows_NT)
	g++ -o hw7 main.o atom.o number.o variable.o struct.o proxy.o list.o node.o term.o -lgtest
else
	g++ -o hw7 main.o atom.o number.o variable.o struct.o proxy.o list.o node.o term.o -lgtest -lpthread
endif
